...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        if not document_types.exists():
            self.stdout.write(self.style.WARNING("No document types found in the database. Run seed_document_types seeder first!"))
            return
        ...
        for doc_type in document_types:
            if doc_type.name == "Specification":
                ...
                self.stdout.write(self.style.WARNING(f"Skipping unknown document type: {doc_type.name}"))

        self.stdout.write(self.style.SUCCESS("Successfully seeded document sections for all document types."))
    ...
    def seed_specification_sections(self, doc_type):
        ...
        self.stdout.write(self.style.SUCCESS("Successfully seeded Specification document sections with prompts and dependencies!"))
    ...
    def seed_srs_sections(self, doc_type):
        ...
        sections_data = [
            ...
            },
            {
                ...
                "dependencies": ["### 2.5 Assumptions and Dependencies", "## 2. Overall Description"]
            },
            {
        ...
        self.stdout.write(self.style.SUCCESS("Successfully seeded SRS document sections with prompts and dependencies!"))