...
from .views import TestModellsView, TestGeneratedTextView, SelectProjectView, SelectDocumentView, GenerateView, GenerateSectionContentView, GenerateDescriptionView, GenerateTitleView, ResultsView

app_name = 'ai-models'

urlpatterns = [
  path('test-models', TestModellsView.as_view(), name='test_models'),
  path('test-generated-text', TestGeneratedTextView.as_view(), name='test_generated_text'),
