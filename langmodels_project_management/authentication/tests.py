...
from authentication.views import CustomLoginView, CustomRegisterView, CustomLogoutView, UseAsGuestView
...
class UseAsGuestViewTests(TestCase):
    ...
    def test_post_redirects_with_warning_message(self):
        ...
        self.assertEqual(str(messages[0]), "You are browsing as a guest. Some features may be unavailable.")
...
class CustomLoginFormTest(TestCase):
    def setUp(self):
        self.user = User.objects.create_user(username='testuser', password='userPass123')
    ...
    def test_field_widget_attributes(self):
        ...
        self.assertEqual(form.fields['username'].widget.attrs['class'], 'form-control border-0 shadow-sm')
        ...
        self.assertEqual(form.fields['password'].widget.attrs['class'], 'form-control border-0 shadow-sm')
...
class CustomRegisterFormTest(TestCase):
    ...
    def test_field_widget_attributes(self):
        ...
        self.assertEqual(form.fields['email'].widget.attrs['class'], 'form-control border-0 shadow-sm')
        ...
        self.assertEqual(form.fields['first_name'].widget.attrs['class'], 'form-control border-0 shadow-sm')
        self.assertEqual(form.fields['first_name'].widget.attrs['placeholder'], 'Enter your first name here...')
        ...
        self.assertEqual(form.fields['last_name'].widget.attrs['class'], 'form-control border-0 shadow-sm')
        self.assertEqual(form.fields['last_name'].widget.attrs['placeholder'], 'Enter your last name here...')
        ...
        self.assertEqual(form.fields['password1'].widget.attrs['class'], 'form-control border-0 shadow-sm')
        ...
        self.assertEqual(form.fields['password2'].widget.attrs['class'], 'form-control border-0 shadow-sm')
        self.assertEqual(form.fields['password2'].widget.attrs['placeholder'], 'Confirm your password...')
        self.assertEqual(form.fields['password2'].widget.attrs['id'], 'confirm_password')
