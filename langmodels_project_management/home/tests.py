...
class HomePageViewTest(TestCase):
    def setUp(self):
        ...
        self.ai_model = AIModel.objects.create(name="Test AI Model", model_identifier="test-ai-model")
    ...
    def test_homepage_context_contains_projects(self):
        ...
        self.assertListEqual(sorted(project_names), ["Project Alpha", "Project Beta", "Project Gamma"])
