...
\begin{frame}{Téma rövid bemutatása}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            % A szakdolgozat célja, hogy bemutassa a mesterséges intelligencia szerepét és integrálhatóságát a webalkalmazásokban, különösen az adminisztratív feladatok megkönnyítésében, mint a dokumentációk és specifikációk gyors létrehozása.  
        \end{itemize}
        ...
        \begin{itemize}
            ...
            % A cél egy olyan webalkalmazás létrehozása, amely gyorsítja az adminisztratív feladatok elvégzését, különösen a dokumentációk és specifikációk elkészítését nyelvi modellek segítségével.  
            \vspace{0.5em}
...
\begin{frame}{Felhasznált technológiák}
    ...
    % Az implementáció során a Django és Python alapú backend, valamint a HTML, CSS, JavaScript és Bootstrap alapú frontend technológiák biztosítják a teljes funkcionalitást és felhasználói élményt.
        % Az adatbázis kezeléséhez az SQLite került kiválasztásra, amely egy könnyen használható, fájl alapú megoldás, ideális kisebb alkalmazásokhoz.
        % A munkaszervezéshez és feladatkövetéshez olyan eszközök kerültek felhasználásra, mint a GitHub Projects és Issues, amelyek lehetővé teszik a projektek hatékony menedzselését és dokumentálását.
        % A verziókövetéshez Git és GitHub alapú megoldások kerültek alkalmazásra, amelyek biztosítják a kódbázis folyamatos verziókezelését és a kollaboráció támogatását.
...
\begin{frame}{Főoldal áttekintés}
  \begin{center}
    \animategraphics[loop,autoplay,width=0.85\textwidth]{1}{gif/home/home_frame-}{0}{17}
  \end{center}
  \begin{itemize}
...
\begin{frame}{Elért eredmények a célkitűzésekkel összehasonlítva}
    \begin{columns}[T]
      ...
      \column{0.42\textwidth}
        ...
        \end{block}
    \end{columns}
    % Célom egy olyan webalkalmazás fejlesztése volt, amely ingyenes nyelvi modellekkel, alacsony hardverigény mellett képes minőségi dokumentációkat és specifikációkat generálni, egyszerűen kezelhető felületen.
